...
jornada: { imagenes: [], tt: { texto:"8 horas/dia" }, sdf:{ texto:"" }, nocturno:{ texto:"Es voluntario y no rotativo. Si no hubiera personal voluntario para el turno de noche se cubrirán los puestos necesarios con personal de día rotando entre todos ellos, excepto de mayores de 60 años, que será voluntario." }, requisitos:{ texto:"Mayor de 18 años y voluntario para mayores de 60 años" }, anual:{ texto:"Para el cálculo de la jornada anual se tendrán en cuenta los festivos de cada año y las vacaciones, asi como el permiso de navidad de 2 días para jornada completa y 1 día para jornada de SDF" }, irregular:{ texto:"La jornada se debe de distribuir de forma regular durante todo el año sin cargar la epoca estival por la falta de personal" }, cambios:{ texto:"Se realizarán por hoja de solicitud. Si se solicita voluntario la empresa podra aceptar dicho cambiom, o no. Si se solicita por conciliación familiar se debera aportar documentación para acreditarlo" }, efectivas:{ texto:"Todas aquellas horas dentro de la jornada laboral incluidas las horas de cobro" }, bocadillo:{ texto:"Se dispondra de 30 minutos para todas las jornadas y turnos" }, complementarias:{ texto:"Tambien llamadas horas extras o jornada extra" } },
  vacaciones: { imagenes: [], tt:{ texto:"31 días naturales de vacaciones" }, sdf:{ texto:"" }, computo:{ texto:"Dias naturales" }, devengo:{ texto:"Se disfrutaran las vacaciones anuales excepto en contratos temporales que se disfrutaran la parte proporcional trabajado desde el 1 de enero de ese mismo año." }, disfrute:{ texto:"Se podra disfrutar por quincenas o meses completos. En caso de querer disfrutar la vacaciones en meses completos habra que solicitarlo antes del 1 de diciembre del año anterior." }, calendario:{ texto:"El cuadrante se entregará antes del 15 de diciembre del mes anterior" }, antiguedad:{ texto:"No procede, se asignará por rotación" } },
  ...
  - Por el tiempo indispensable por estancia en urgencias hospitalarias, debidamente  acreditada, del cónyuge o un familiar en primer grado de consanguinidad.
   Todas estas licencias y permisos deberán ser preavisados, salvo urgencias, y posteriormente  justificados debidamente. Además, todos estos permisos serán disfrutados tanto por los  matrimonios como por las parejas de hecho debidamente inscritas en el registro oficial. ` }, noretribuidos:{ texto:"Todos aquellos que no vienen en el articulo 18 del convenio colectivo y en el plan de igualdad" }, hospitalizacion:{ texto:`Como marca el convenio en el Articulo 18. C
   ...
   IMPORTANTE: Se disfrutarán en días laborables consecutivos siempre y cuando continue el hecho causante que en cuyo caso se pararia el permiso.` }, fallecimiento:{ texto:`Como marca el convenio en su Articulo 18.e
