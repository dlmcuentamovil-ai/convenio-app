...
- Incremento de 1€ en el año 2031` }, festividad:{ texto:"No aplica" }, peligrosidad:{ texto:"No aplica" }, turnicidad:{ texto:"No aplica" }, transporte:{ texto:"El plus trasporte viene regulado en las tablas salariales" }, asistencia:{ texto:`Artículo 31. – Prima compensatoria por la asistencia al trabajo.
...
Un total de 15 festivos/año` }, recuperaciones:{ texto:"No aplica" } },
...
forzosa:{ texto:`La excedencia forzosa es una suspensión del contrato de trabajo que la empresa está obligada a conceder
Se concede exclusivamente en tres supuestos:
- Cargo público
- Funciones sindicales
- Deber inexcusable
Los/as trabajadores/as que soliciten la excedencia forzosa como consecuencia de haber sido nombrados para el ejercicio de cargos públicos y/o sindicales, no necesitarán de un año de antigüedad para solicitarla, concediéndose obligatoriamente en estos casos, siendo admitidos/as inmediatamente al cumplir su mandato.` }, 
  cuidado:{ texto:`Las personas trabajadoras justifiquen una necesidad excepcional, por cuidado de familiares de primer grado de afinidad o consanguinidad o cónyuge, la Empresa estudiará la posibilidad de que se puedan conceder excedencias por períodos mínimos de 15 días.
...
Un par de botas de agua.` } },
  mejoras: { imagenes: [], seguro:{ texto:`SEGURO COLECTIVO DE VIDA:
